...
namespace Portfolio.Services.WorkItems.Infrastructure.Migrations
{
    ...
    [Migration("20220402195504_CreateTableContact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Services.WorkItems.Domain.WorkAggregate.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("MailSendError")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Portfolio.Services.WorkItems.Domain.WorkAggregate.Contact", b =>
                {
                    b.HasOne("Portfolio.Services.WorkItems.Domain.WorkAggregate.Category", "Categories")
                        .WithMany()
